...
#else
        protected readonly PseudoRandomNumberGenerator qRNG; //QuantumRandomNumberGenerator qRNG;
#endif
...
#else
            qRNG = new PseudoRandomNumberGenerator(); // QuantumRandomNumberGenerator();
